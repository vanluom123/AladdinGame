...
CivilianEnemy2nd::CivilianEnemy2nd(GVector2 position, Player* mplayer)
{
	this->Tag = Entity::CivilianEnemy2nd;
	this->HP = 1;
	this->mCivilianEnemy2ndData = new CivilianEnemy2ndData();
...
void CivilianEnemy2nd::Draw(GVector3 position, RECT sourceRect, GVector2 scale, GVector2 transform, float angle, GVector2 rotationCenter, D3DXCOLOR colorKey)
{
...
void CivilianEnemy2nd::Draw(GVector2 transform)
{
	mCurrentAnimation->SetFlipHorizontal(mCurrentReverse);
	mCurrentAnimation->SetPosition(this->GetPosition());
...
void CivilianEnemy2nd::OnSetPosition(GVector3 pos)
{
