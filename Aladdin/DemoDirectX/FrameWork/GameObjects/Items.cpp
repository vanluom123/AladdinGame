...
bool Items::init(GVector3 position)
{
...
bool Items::init(GVector3 position, ItemTypes type)
{
...
Items::Items(GVector2 position, ItemTypes type)
{
	init(GVector3(position.x, position.y, 0), type);
}
Items::Items(GVector3 position)
{
	init(position);
}
Items::Items(GVector3 position, ItemTypes type)
{
	init(position, type);
}

void Items::OnSetPosition(GVector3 pos)
{
...
void Items::Draw(GVector3 position, RECT sourceRect, GVector2 scale, GVector2 transform, float angle, GVector2 rotationCenter, D3DXCOLOR colorKey)
{
...
void Items::Draw(GVector3 transform)
{}

void Items::Draw(GVector2 transform)
{
